...
namespace ASPNETIdentityDemo.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Bạn chưa nhập password")]
        [StringLength(100, ErrorMessage = "Mật khẩu phải tối thiểu {0} và tối đa {1}", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
        ...
        [Compare("Password", ErrorMessage = "Mật khẩu và xác thực mật khẩu chưa trùng khớp")]
    ...
    {
        [Required(ErrorMessage = "Vui longf nhaapj")]
